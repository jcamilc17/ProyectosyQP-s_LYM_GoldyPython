...
public final class Lexer202420 {
  ...
  public static Object initialize() {
    ...
    $try:try {
      ...
      $line=219;
      Object definitions=$fix(GCollections.asSet("NEW","VAR","MACRO"));
      $line=220;
      Object controlStructs=$fix(GCollections.asSet("if","then","else","fi","do","od","rep","times","per"));
      $line=221;
      Object commands=$fix(GCollections.asSet("turnToMy","turnToThe","walk","jump","drop","pick","grab","letGo","pop","moves","nop","safeExe"));
      $line=222;
      Object conditions=$fix(GCollections.asSet("isBlocked?","isFacing?","zero?","not"));
      $line=223;
      Object directions=$fix(GCollections.asSet("right","left","back","forward","front","north","east","west","south","backwards"));
      $line=224;
      Object constants=$fix(GCollections.asSet("size","myX","myY","myChips","myBalloons","balloonsHere","chipsHere","roomForChips"));
      $line=226;
      keyWords=$cast(ISet.class,$fix($opUnionY($opUnionY($opUnionY($opUnionY($opUnionY($opUnionY(GCollections.asSet("EXEC"),definitions),controlStructs),commands),conditions),constants),directions)));
      $line=227;
      allSymbols=$cast(ISet.class,$fix(GCollections.asSet("(",")",";","{","}",",","=")));
      $line=235;
      ((gold.structures.map.GHashTableMap)translation).put("EXEC",'X');
      $line=238;
      ((gold.structures.map.GHashTableMap)translation).put("NEW",'N');
      $line=239;
      ((gold.structures.map.GHashTableMap)translation).put("VAR",'V');
      $line=240;
      ((gold.structures.map.GHashTableMap)translation).put("MACRO",'M');
      $line=243;
      ...
      $line=257;
      ((gold.structures.map.GHashTableMap)translation).put("backwards",'B');
      $line=258;
      ...
      $line=266;
      ((gold.structures.map.GHashTableMap)translation).put("letGo",'L');
      $line=267;
      ((gold.structures.map.GHashTableMap)translation).put("pop",'K');
      $line=268;
      ((gold.structures.map.GHashTableMap)translation).put("moves",'m');
      $line=269;
      ((gold.structures.map.GHashTableMap)translation).put("nop",'Y');
      $line=270;
      ((gold.structures.map.GHashTableMap)translation).put("safeExe",'S');
      $line=273;
      ((gold.structures.map.GHashTableMap)translation).put("isBlocked?",'B');
      $line=274;
      ((gold.structures.map.GHashTableMap)translation).put("isFacing?",'C');
      $line=275;
      ((gold.structures.map.GHashTableMap)translation).put("zero?",'z');
      $line=276;
      ((gold.structures.map.GHashTableMap)translation).put("not",'-');
      $line=279;
      ((gold.structures.map.GHashTableMap)translation).put("if",'i');
      $line=280;
      ((gold.structures.map.GHashTableMap)translation).put("then",'>');
      $line=281;
      ((gold.structures.map.GHashTableMap)translation).put("else",'E');
      $line=282;
      ((gold.structures.map.GHashTableMap)translation).put("fi",'Z');
      $line=283;
      ((gold.structures.map.GHashTableMap)translation).put("do",'D');
      $line=284;
      ((gold.structures.map.GHashTableMap)translation).put("od",'G');
      $line=285;
      ((gold.structures.map.GHashTableMap)translation).put("rep",'R');
      $line=286;
      ((gold.structures.map.GHashTableMap)translation).put("times",'x');
      $line=287;
      ((gold.structures.map.GHashTableMap)translation).put("per",'U');
      $line=290;
